...
```json
"com.juliennoe.assets-scanner": "https://github.com/juliennoe/assetsfoldersoverviewscanner.git"
```

Or download and place the folder in `Packages/AssetFoldersOverviewScanner`.
